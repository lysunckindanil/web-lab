...
VALUES (10, 'Как правильно настроить баланс белого?',
        'Баланс белого зависит от освещения. Для точной настройки используйте серую карту или ручной режим. При съёмке в RAW корректируйте температуру в постобработке. В помещении с лампами накаливания выбирайте预设 "Тungsten", а для облачной погоды — "Cloudy". Автоматический режим не всегда точен.',
        NOW(),
        10);
